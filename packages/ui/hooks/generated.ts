...
export const vaporABI = [
  ...
  },
  {
    ...
    name: 'getInitialSettingsManifest',
    outputs: [
      {
        name: '',
  ...
  },
  {
    ...
    type: 'function',
    inputs: [{ name: 'gameID', internalType: 'uint256', type: 'uint256' }],
    name: 'getPlayerSettingsManifest',
    outputs: [
      {
        name: '',
        internalType: 'struct Vapor.SettingDeclaration[]',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link demoGameABI}__.
 */
export function useDemoGameRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof demoGameABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof demoGameABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({
    abi: demoGameABI,
    ...config,
  } as UseContractReadConfig<typeof demoGameABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link demoGameABI}__ and `functionName` set to `"vaporGameID"`.
 */
export function useDemoGameVaporGameId<
  TFunctionName extends 'vaporGameID',
  TSelectData = ReadContractResult<typeof demoGameABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof demoGameABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link vaporABI}__ and `functionName` set to `"getInitialSettingsManifest"`.
 */
export function useVaporGetInitialSettingsManifest<
  TFunctionName extends 'getInitialSettingsManifest',
  TSelectData = ReadContractResult<typeof vaporABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof vaporABI, TFunctionName, TSelectData>,
  ...
  return useContractRead({
    abi: vaporABI,
    functionName: 'getInitialSettingsManifest',
    ...config,
  } as UseContractReadConfig<typeof vaporABI, TFunctionName, TSelectData>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link vaporABI}__ and `functionName` set to `"getPlayerSettingsManifest"`.
 */
export function useVaporGetPlayerSettingsManifest<
  TFunctionName extends 'getPlayerSettingsManifest',
  TSelectData = ReadContractResult<typeof vaporABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof vaporABI, TFunctionName, TSelectData>,
  ...
  return useContractRead({
    abi: vaporABI,
    functionName: 'getPlayerSettingsManifest',
    ...config,
  } as UseContractReadConfig<typeof vaporABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link vaporABI}__ and `functionName` set to `"getStartSettingsManifest"`.
 */
export function useVaporGetStartSettingsManifest<
  TFunctionName extends 'getStartSettingsManifest',
  TSelectData = ReadContractResult<typeof vaporABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof vaporABI, TFunctionName, TSelectData>,
  ...
  return useContractRead({
    abi: vaporABI,
    functionName: 'getStartSettingsManifest',
    ...config,
  } as UseContractReadConfig<typeof vaporABI, TFunctionName, TSelectData>)
}
